...
public class HttpAdapterConnectorTest extends VertxTest {
    ...
    public void callShouldReturnGdprAwareAdapterResponseWithNoCookieIfNoAdapterUidInCookieAndNoAppInPreBidRequest()
        ...
        assertThat(adapterResponse.getBidderStatus().getUsersync())
                .isEqualTo(UsersyncInfo.of("http://url?redir=%26gdpr%3D1%26gdpr_consent%3Dconsent%241%26us_privacy=1--",
                        null, false));
    }
    ...
    public void callShouldReturnGdprAwareAdapterResponseWithNoCookieIfNoAdapterUidInCookieAndNoAppInPreBidRequestWithAccount()
            throws IOException {
        // given
        final Regs regs = Regs.of(0, Json.mapper.valueToTree(ExtRegs.of(1, null)));
        final User user = User.builder()
                .ext(Json.mapper.valueToTree(ExtUser.builder().consent("consent$1").build()))
                .build();
