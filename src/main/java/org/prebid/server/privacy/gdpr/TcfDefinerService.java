...
public class TcfDefinerService {
    ...
    public Future<TcfContext> resolveTcfContext(
            Privacy privacy, String country, String ipAddress, AccountGdprConfig accountGdprConfig, Timeout timeout) {

        return resolveTcfContext(privacy, country, ipAddress, accountGdprConfig, null, timeout);
    }
