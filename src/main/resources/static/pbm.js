/* pbm.js v0.0.4 Updated : 2018-02-01 */ ! function(e) {
    function t(r) {
    ...
    function o(e) {
        ...
        return r.open("GET", "https://prebid-server.rubiconproject.com/cache?uuid=" + t, !1), r.withCredentials = "true", u.logTimestamp("Adm is requested"), r.send(null), 200 === r.status ? n = r.responseText : u.logError("Error request adm cache id"), n
    }
